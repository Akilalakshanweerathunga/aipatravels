...
export default function DestinationLineup({ items = [], images = [] }: Props) {
          ...
          return (
            ...
            >
              ...
              >
                ...
                <CardMedia
                  component="img"
                  image={`/images/destinations/${image?.banner_image || 'placeholder.jpg'}`}
                  alt={item.place_name}
                  className="image"
                  sx={{
                    height: '100%',
